 ...
 * </p>
 * <ul>
 *   <li>{@link fr.hma.easycdo.demo.impl.NodeImpl#getID <em>ID</em>}</li>
 *   <li>{@link fr.hma.easycdo.demo.impl.NodeImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.hma.easycdo.demo.impl.NodeImpl#getNodes <em>Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeImpl extends CDOObjectImpl implements Node {
	...
	protected EClass eStaticClass() {
		return DemoPackage.Literals.NODE;
	}
